...
<section id="breadcrumb">
   <div class="wrapper_12">
      ...
      <a href="http://<?php echo $url ?>about-us/overview.php">About Us</a> <span class="b_arrow">&rsaquo;</span> <span>Board of Directors</span>
   </div>
</section>
<!-- end breadcrumb -->
...
<section id="middle">
   <div class="wrapper_12">
      ...
      <!-- end minor_side -->
      <aside id="mainSide">
         <h1 class="content_title">Board of Directors</h1>

            <div class="grid_pstructure person_1 gs_l">
            <!--<div class="img"><img src="http://<?php echo $url ?>images/content/person-3.jpg" alt=""/></div>-->
            <div class="name_of">Robert Meyer</div>
         ...
         <div class="reset_grid">
            <a class="btn " href="">Explore Our Business</a>
         </div>
         <p>&nbsp;</p>
      </aside>
      <!-- end mainSide -->
