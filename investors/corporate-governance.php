...
<section id="breadcrumb">
   ...
   <div class="wrapper_12">
      ...
      <a href="http://<?php echo $url ?>investors/corporate-governance.php">Investors</a> <span class="b_arrow">&rsaquo;</span> <span>Corporate Governance</span>
...
<section id="middle">
   ...
   <div class="wrapper_12">
      ...
      <aside id="mainSide">
         ...
         <h1 class="content_title">Corporate Governance</h1>

<!--         <div class="content_intro">Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. 
            ...
            Sed non  mauris vitae erat consequat auctor eu in elit. </div>

         

         <img src="http://<?php echo $url ?>images/content/investors-corporate.jpg" alt="" />-->
         ...
         <p>Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc. 

            Etiam pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Suspendisse in orci enim.</p>
         ...
         <!--<div class="reset_grid">
            ...
            <a class="btn" href="http://<?php echo $url ?>investors/financial-reports-and-disclosures.php">Financial Reports &amp; Disclosures</a>
